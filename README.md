...
* `detail-kelas-pendaftaran.html`: Halaman detail kelas, pilihan paket, dan formulir pendaftaran.
* `assets/`: Folder berisi semua aset statis (gambar, CSS, JavaScript, font) yang diperlukan oleh website.
* `README.md`: File ini, berisi deskripsi proyek.

## Cara Mengakses Website

Website ini di-deploy menggunakan GitHub Pages dan dapat diakses melalui link berikut:

[**https://wenyclaudia.github.io/Healthy-Life/**](https://wenyclaudia.github.io/Healthy-Life/)

## Kontribusi & Pengembang

Proyek ini dikembangkan oleh:

* **Weny Paskah Claudia Nazara (04022047)**
* **Aidah Aidul Fitri (04024059)**
* **Reynaldo Nathaniel Christian Agung (04023016)**

## Teknologi yang Digunakan

* **Mobirise:** Sebagai Website Builder.
* **HTML5, CSS3, JavaScript:** Dasar pengembangan website.
* **Git & GitHub Pages:** Untuk Version Control dan Hosting.
